...
import win.lioil.bluetooth.util.HIDUtils;

/**
 * 获取蓝牙设备类型 https://blog.csdn.net/BigBoySunshine/article/details/107536146
 */
...
//        mTips.setText("正在连接...");
        ...
        HIDUtils.getInstance(this).pair(dev);
    }
